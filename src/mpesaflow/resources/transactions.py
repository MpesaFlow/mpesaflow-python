...
from ..types.transaction_retrieve_status_response import TransactionRetrieveStatusResponse
...
class TransactionsResource(SyncAPIResource):
    ...
    def retrieve_status(
        ...
        *,
    ...
    ) -> TransactionRetrieveStatusResponse:
        """
        ...
        return self._get(
            ...
            cast_to=TransactionRetrieveStatusResponse,
        )
