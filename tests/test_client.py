...
class TestMpesaflow:
    client = Mpesaflow(
        base_url=base_url, app_api_key=app_api_key, root_api_key=root_api_key, _strict_response_validation=True
    )
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(root_api_key="another My Root API Key")
        assert copied.root_api_key == "another My Root API Key"
        assert self.client.root_api_key == "My Root API Key"
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MpesaflowError):
            with update_env(**{"APP_API_KEY": Omit()}):
                client2 = Mpesaflow(
                    base_url=base_url, app_api_key=None, root_api_key=root_api_key, _strict_response_validation=True
                )
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(MPESAFLOW_BASE_URL="http://localhost:5000/from/env"):
            client = Mpesaflow(app_api_key=app_api_key, root_api_key=root_api_key, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Mpesaflow(
            base_url=base_url, app_api_key=app_api_key, root_api_key=root_api_key, _strict_response_validation=False
        )
...
class TestAsyncMpesaflow:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MPESAFLOW_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMpesaflow(
                app_api_key=app_api_key, root_api_key=root_api_key, _strict_response_validation=True
            )
            assert client.base_url == "http://localhost:5000/from/env/"
